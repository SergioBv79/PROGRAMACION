...
public class MainClase1 {
    public static void main(String[] args) {
        ...
        byte byteVariable = 10;      // Tipo byte (rango de -128 a 127)
        short shortVariable = 1000;  // Tipo short (rango de -32,768 a 32,767)
        int intVariable = 100000;    // Tipo int (rango de -2,147,483,648 a 2,147,483,647)
        long longVariable = 1000000L; // Tipo long (rango de -9,223,372,036,854,775,808 a 9,223,372,036,854,775,807)

        System.out.println("Valor de byte: " + byteVariable);
        System.out.println("Valor de short: " + shortVariable);
        System.out.println("Valor de int: " + intVariable);
